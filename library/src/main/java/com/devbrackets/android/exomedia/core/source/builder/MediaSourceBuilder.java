...
public abstract class MediaSourceBuilder {
    ...
    @NonNull
    public abstract MediaSource build(@NonNull Context context, @NonNull Uri uri,@Nullable Uri audioUrl, @NonNull String userAgent, @NonNull Handler handler, @Nullable TransferListener<? super DataSource> transferListener);
